...
const BecomeVendorPage: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      {/* Main Content Area */}
      <div className="flex-grow flex flex-col items-center justify-center p-4 md:p-8 md:pl-64">
        {/* Header */}
        ...
        <section className="w-full max-w-xl space-y-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <p className="text-gray-600">
              ...
              <a
                href="mailto:vendor@profitplus.com"
                className="text-blue-600 hover:underline"
              >
                vendor@profitplus.com
              </a>{" "}
              for approval.
            </p>
            <ul className="list-disc list-inside text-gray-600 mt-4">
              ...
              <li>Price of Product: Specify the cost of your product.</li>
              <li>
                Commission Offers: Indicate the percentage affiliates will earn per
                sale.
              </li>
              <li>
                Customer Support Information: Provide contact details for buyers to
        ...
        <section className="mt-8 w-full max-w-xl bg-white shadow-md rounded-lg p-6">
          ...
          <p className="text-gray-600">
            profitplus automatically collects and splits sales payments among you,
            the affiliates, and the platform.
          </p>
          <ul className="list-disc list-inside text-gray-600 mt-4">
            <li>
              profitplus charges a 10% transaction fee for each sale. For example,
              if your product costs ₦30,000, profitplus deducts ₦3,000, leaving
              you with ₦27,000.
            </li>
            <li>
            ...
            <li>
              All products listed on profitplus come with a refund policy to
              protect buyers.
            </li>
          </ul>
        </section>
